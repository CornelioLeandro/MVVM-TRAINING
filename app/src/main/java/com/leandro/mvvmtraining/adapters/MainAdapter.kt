package com.leandro.mvvmtraining.adapters
...
import com.leandro.mvvmtraining.R
import com.leandro.mvvmtraining.databinding.ResItemLiveBinding
import com.leandro.mvvmtraining.models.Live

class MainAdapter(private val onItemClicked: (Live) -> Unit) : RecyclerView.Adapter<MainAdapter.MainViewHolder>() {
